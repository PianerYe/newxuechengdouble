...
//    @NotEmpty(message = "适用人群不能为空",groups = {ValidationGroups.Update.class})
    @Size(message = "适用人群过少",min = 10)
//    @Size(message = "适用人群过少",min = 10,groups = {ValidationGroups.Inster.class})
//    @Size(message = "适用人群过少",min = 10,groups = {ValidationGroups.Update.class})
...
//    @Size(message = "课程描述内容过少",min = 10,groups = {ValidationGroups.Inster.class})
//    @Size(message = "课程描述内容过少",min = 10,groups = {ValidationGroups.Update.class})
