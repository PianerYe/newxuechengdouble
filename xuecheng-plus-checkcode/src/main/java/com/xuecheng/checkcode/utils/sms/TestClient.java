...
package com.xuecheng.checkcode.utils.sms;
...
public class TestClient {
    ...
    public static void main(String[] args) {
        ...
        client.setAppId("hw_11354");     //开发者ID，在【设置】-【开发设置】中获取
        ...
        request.setBizContent("{\"mobile\":[\"18616856295\"],\"type\":0,\"template_id\":\"ST_2020101100000004\",\"sign\":\"" + singnstr +"\",\"send_time\":\"\",\"params\":{\"code\":1234}}");  // 这里是json字符串，send_time 为空时可以为null, params 为空时可以为null,短信签名填写审核后的签名本身，不需要填写签名id
